...
parser = argparse.ArgumentParser(description="An example of using llama.cpp to host sagemaker endpoint server. It must be used together with server.cpp.")
...
def make_postData(body, chat=False, stream=False):
    ...
    if (chat):
        ...
        if(is_present(body, "ask")): 
            postData["prompt"] = body["ask"]
        else:
