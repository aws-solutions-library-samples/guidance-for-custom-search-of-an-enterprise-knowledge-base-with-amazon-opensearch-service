...
// import {DEFAULT_PREFERENCES, Preferences} from './common/config';
// import {
//     Pagination,
//     Table,
//     TextFilter,
...
//         sortingField: 'fmodel',
//         header: 'fmodel',
//         cell: item => item.fmodel,
//         minWidth: 100,
//     },
//     {
//         id: 'fhelpcode',
//         sortingField: 'fhelpcode',
//         header: 'fhelpcode',
//         cell: item => item.fhelpcode,
//         minWidth: 100,
//     }
// ]);
//
...
//                          withML = 10,
//     ) => {
//         // console.log('==> updateItems' ,query,withML )
...
//                     _tmp['fid'] = item['_source']['fid']
//                     _tmp['fname'] = item['_source']['fname']
//                     _tmp['fmodel'] = item['_source']['fmodel']
//                     _tmp['fhelpcode'] = item['_source']['fhelpcode']
